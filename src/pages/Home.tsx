...
export default function Home() {
 ...
 <div className="">
 <h2
                  className="font-bold text-4xl flex justify-center text-left py-2 max-639:justify-center max-639:text-4xl main
           text-mainDarkCyan dark:text-white lg:text-5xl"
                >
Where I'm

                </h2>
                <p className="text-center text-mainSilver/50 py-2">Let's connect!</p>
